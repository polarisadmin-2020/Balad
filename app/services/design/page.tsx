...
import { ArrowRight, Search, X, Copy, Trash, Edit, Hash, Calendar, Phone, Mail, User, FileText, CheckSquare, MapPin, Circle, ChevronDown, File, Image, Lock } from 'lucide-react';
...
import Pagination from '@monorepo/shared-ui/src/components/Pagination';
import { colors } from '@monorepo/shared-ui/src/styles/colors';
import { loadTranslations, getTranslation } from '../../../public/utils/translations';
import './styles.css';
...
export default function ServiceDesignPage() {
  ...
  return (
    <div className="service-design-container" dir={language === 'ar' ? 'rtl' : 'ltr'}>
      {/* Header with tabs */}
      <div className="service-design-header">
        {/* Back button moved to the right */}
        <div className="back-button">
          <div className="back-button-inner">
            <img src="/icons/arrow_right.svg" alt="Back" className="h-5 w-5" />
          </div>
        </div>
        
        <div className="tabs-container">
          <div className="tabs">
            {/* Right tab should display إنشاء الحقول */}
            <div 
              className={`tab ${activeTab === 'fields' ? 'active' : ''}`} 
              onClick={() => handleTabChange('fields')}
            >
              <div className="tab-title">
                <div className="tab-text">إنشاء الحقول</div>
              </div>
              {activeTab === 'fields' && (
            ...
            {/* Left tab should display إنشاء النماذج */}
            <div 
              className={`tab ${activeTab === 'templates' ? 'active' : ''}`} 
              onClick={() => handleTabChange('templates')}
            >
              <div className="tab-title">
                <div className="tab-text">إنشاء النماذج</div>
              </div>
              {activeTab === 'templates' && (
                <div className="selection-indicator">
                  <div className="selector"></div>
        ...
        <div className="main-content">
          {isLoading ? (
            ...
            <>
              ...
              {/* Pagination using shared-ui component */}
