    ...
    <div className="min-h-screen bg-background p-8">
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <ComponentCard 
            title="NavHeader" 
            description="Navigation header with menus"
            href="/examples/nav-header"
          />
          <ComponentCard 
            title="Tag" 
            description="Label or categorize content"
            href="/examples/tag"
          />
          <ComponentCard 
            title="Switch" 
            description="Toggle between two states"
            href="/examples/switch"
          />
          <ComponentCard 
            title="TextInput" 
          ...
          <ComponentCard 
            title="DatePicker" 
            description="Select dates or date ranges"
